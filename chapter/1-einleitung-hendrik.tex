...
In der Ära der Mainframe Computer wurden simple Wartelisten, die von einer OperatorIn betreut wurden, nach und nach durch ausgeklügelte Systeme ersetzt %(einfügen: ich hätte gerne so eine "history of Computing" mäßige Quelle).
